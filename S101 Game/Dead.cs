...
namespace S101_Game
{
    ...
    public class Dead : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            textureBG = Content.Load<Texture2D>("IDLETitle");
            _BG = new Sectors(textureBG)
            {
                Position = new Vector2(ScreenWidth/2 - textureBG.Width/2 - 300, ScreenHeight/2 - textureBG.Height/2),
            };
            ...
            _silverMan = new MenuFont(font)
            {
                ...
                Position = new Vector2(ScreenWidth / 3f, 75),
                Layer = 1f,
            };
            ...
            _scoreSprite = new MenuFont(font)
            {
                write = $"Meilleur score: {scr}!",
                Position = new Vector2(ScreenWidth / 2.7f, 280)
            };
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _scoreSprite.Draw(gameTime, spriteBatch);
